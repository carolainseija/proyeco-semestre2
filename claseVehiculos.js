class Vehiculos{
   ...
   venta(id,reservar){
    ...
    //modificar los datos del elemento segun id  y retornarlo
    // name y price
    modificacion(id,datosModificar){
        //
        console.log("datosModificar", datosModificar)
    ...
    cargar() {
        ...
        fs.readFile('datosAutos.json', (error, dato) => {
            if (error) {
                ...
                const objetoAuto = JSON.parse(dato); // ver de cambiar el nombre
